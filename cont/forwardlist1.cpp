...
void printLists (const string& s, const forward_list<int>& list, int listNum = 0)    // lhf add
{
    cout << s << endl;
    if (listNum > 0) {
            cout << "list" << listNum << ": ";
...
int main()
{
    ...
    list2.insert_after(list2.before_begin(),98);
    printLists("insert_after : ", list2, 2);    // lhf add
    list2.push_front(10);
    printLists("push_front : ", list2, 2);   // lhf add
